            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.settings.index') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all
                              {{ request()->routeIs('admin.settings*') ? 'bg-rose-500/10 text-rose-400' : 'text-charcoal-300 hover:text-white hover:bg-charcoal-800' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        ...
                        <span class="whitespace-nowrap transition-opacity duration-200"
                            :class="sidebarOpen ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden'">System Settings</span>
                    </a>
                </div>
            </div>
        @endif
