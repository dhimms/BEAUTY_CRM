...
@section('page-actions')
    <div class="flex gap-2">
        ...
        <form action="{{ route('admin.leads.destroy', $lead) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this lead?');" class="inline">
            @csrf
            @method('DELETE')
            <button type="submit" class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-rose-600 border border-transparent rounded-xl hover:bg-rose-700 focus:ring-4 focus:ring-rose-200 transition-all">
            ...
            <div class="p-0">
                ...
                @else
                    <div class="px-6 py-8 text-center text-charcoal-500">
                        <svg class="w-12 h-12 mx-auto text-charcoal-300 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/></svg>
